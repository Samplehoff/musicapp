...
app.get('/create-artist', function (req, response){
  response.sendFile(__dirname+'/public/create_artist.html')
  //response.render('create_artist')
})
